    ...
    <div className="flex w-full items-stretch justify-between gap-5 bg-black p-4">
      {isConnected && address ? (
        <>
          ...
          />
          <button className="border-[color:var(--White,#FCFCFC)] self-stretch flex w-[155px] max-w-full flex-col px-4 py-2 rounded-[200px] border-2 border-solid justify-center items-center hover:bg-white text-zinc-50 text-center text-xs font-bold whitespace-nowrap">
