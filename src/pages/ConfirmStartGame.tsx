...
function HideAlex() {
  ...
  return (
    <div className="flex flex-col h-screen justify-center items-center bg-gray-100 p-4 md:px-32">
      ...
      <h2 className="mb-6 text-2xl font-bold">Pick where to Hide Alex!</h2>
      <div className="mb-6 grid gap-4">
        <button onClick={() => handleHideChoice('In Weeds')} className="relative">
          <img src="path_to_in_weeds_image" alt="In Weeds" className="rounded-md w-40 h-40" />
        ...
        <button onClick={() => handleHideChoice('Behind Building')} className="relative">
          <img src="path_to_behind_building_image" alt="Behind Building" className="rounded-md w-40 h-40" />
